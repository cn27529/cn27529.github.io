...
var Digest = function (_Base) {
    ...
    function Digest(options, checker) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Digest).call(this, options, checker));
            ...
            if (this.validateNonce(co.nonce, co.qop, co.nc)) {
                (function () {
                    ...
                    if (_this2.checker) {
                        ...
                        callback.apply(_this2, [{ user: found ? co.username : undefined }]);
                    }
                })();
            } else {
